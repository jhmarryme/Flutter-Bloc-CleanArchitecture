...
class MyPageIndexBloc extends BaseBloc<MyPageIndexEvent, MyPageIndexState> {
  ...
  FutureOr<void> _onOtpButtonPressed(
    ...
    // final String? token = await navigator.popAndPush(AppRouteInfo.myPageOtp('fake'));
    // logD('token: $token');
    EasyThrottle.throttle('_onOtpButtonPressed', const Duration(milliseconds: 500), () {
      navigator.popAndPush(AppRouteInfo.myPageOtp('fake'));
    });
  }
}
